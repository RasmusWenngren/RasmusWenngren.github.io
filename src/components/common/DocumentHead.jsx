...
export default function DocumentHead({
    ...
    useEffect(() => {
        ...
        updateMetaTag('meta[name="viewport"]', 'width=device-width, initial-scale=1.0, viewport-fit=cover');
        ...
        updateMetaTag('meta[name="apple-mobile-web-app-title"]', title || 'Rasmus Wenngren Portfolio');
        ...
        if (ogDescription) updateMetaTag('meta[name="twitter:description"]', ogDescription);
        ...
        if (!manifestLink) {
            ...
            manifestLink.setAttribute('href', '/dynamic-cv-portal/manifest.json');
        ...
        if (!appleIcon) {
            ...
            appleIcon.setAttribute('href', '/dynamic-cv-portal/icons/icon-192x192.png');
